...
public class RelatorioFuncionarioJD extends javax.swing.JDialog {
    ...
    public RelatorioFuncionarioJD(java.awt.Frame parent, boolean modal, FuncionarioDAOImpl funcionarioDAOImpl, String url) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Map<String, Object> parameters = converterHashMap(funcionarioDAOImpl.relatorio());

            JasperReport jr = JasperCompileManager.compileReport("src/main/java/report/relatorioFuncionario.jrxml");
    ...
    private Map<String, Object> converterHashMap(Map<Integer, Funcionario> mapaOriginal) {
        Map<String, Object> novoMapa = new HashMap<>();

        for (Map.Entry<Integer, Funcionario> entry : mapaOriginal.entrySet()) {
